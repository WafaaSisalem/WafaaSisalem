...
> A secure, feature-rich journaling app that combines mood tracking, location tagging, and multimedia support.
>
> * **Tech Stack:** `Flutter` `Bloc` `Firebase Auth/Firestore` `Supabase Storage` `Google Maps`
> * **Key Features:** Secure lock, Calendar view, Weather integration.
